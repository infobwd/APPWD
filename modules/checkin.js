...
;(()=>{try{const st=document.createElement('style');st.id='checkin-zfix2';st.textContent='#map{position:relative}.leaflet-container{z-index:1}#btnOpenScanner,#btnCheckin,#btnRefreshGeo,#btnGpsOnly{z-index:1000}';document.head.appendChild(st);}catch(_){}})();
