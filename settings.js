...
export function wireProfileSettings(){
  const fs=document.getElementById('fsRange'), ic=document.getElementById('icRange'), th=document.getElementById('thSel'), save=document.getElementById('btnSaveSettings')||document.getElementById('savePrefs');
  const obj = JSON.parse(localStorage.getItem('APPWD_SETTINGS')||'{}');
